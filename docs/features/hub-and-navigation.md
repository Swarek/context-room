...
The hub is the first screen for review-first work. It shows `Changed files to review` first, then health, guidance, the explorer, and card navigation.

## Example Flow

1. Open Context Room.
2. Start with `Changed files to review`.
